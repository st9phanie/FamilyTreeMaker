    ...
    return (
        <SidebarLayout>
            ...
            <div className='flex flex-col gap-y-2 '>
                <img src={selectedPerson.photo || "/FamilyTreeMaker/public/blackdefaultpfp.jpg" } loading="lazy" className=' size-24 place-self-center rounded-full border-2 border-sidebar-border ' />
